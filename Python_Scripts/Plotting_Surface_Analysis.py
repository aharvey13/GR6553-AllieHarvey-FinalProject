...
ax.set_extent((-120, -70, 23, 50)) #Extent of CONUS

# Parse the bulletin and plot it
df = parse_wpc_surface_bulletin('afos.10.12.12Z.txt')
plot_bulletin(ax, df)

ax.set_title(f'WPC Surface Analysis Valid {df.valid.dt.strftime("%HZ %d %b %Y")[0]}')
#plt.show()
plt.savefig('WPC_Surface_12Z.png')
...
# Parse the bulletin and plot it
df = parse_wpc_surface_bulletin('afos.10.12.15Z.txt')
plot_bulletin(ax, df)

ax.set_title(f'WPC Surface Analysis Valid {df.valid.dt.strftime("%HZ %d %b %Y")[0]}')
#plt.show()
plt.savefig('WPC_Surface_15Z.png')
...
# Parse the bulletin and plot it
df = parse_wpc_surface_bulletin('afos.10.12.18Z.txt')
plot_bulletin(ax, df)

ax.set_title(f'WPC Surface Analysis Valid {df.valid.dt.strftime("%HZ %d %b %Y")[0]}')
#plt.show()
plt.savefig('WPC_Surface_18Z.png')
...
# Parse the bulletin and plot it
df = parse_wpc_surface_bulletin('afos.10.12.21Z.txt')
plot_bulletin(ax, df)

ax.set_title(f'WPC Surface Analysis Valid {df.valid.dt.strftime("%HZ %d %b %Y")[0]}')
#plt.show()
plt.savefig('WPC_Surface_21Z.png')