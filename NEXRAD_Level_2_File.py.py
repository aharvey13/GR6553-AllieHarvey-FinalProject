...
###########################################
#This script is for each radar scan - I had 51 in total that I put into a loop
#For example, this is the radar scan file for 20:54:34 on October 12, 2020
# Open the file
f = Level2File('KMKX20201012_205434_V06')
...
#Title will have the radar scan time that will need to be changed everytime the script is run 
plt.title('KMKX Radar Base Reflectivity: 2054Z')
#For the file name, I put the radar identifier and the time given in the original file name
plt.savefig('KMKX Radar 205434')
plt.show()
plt.close()
